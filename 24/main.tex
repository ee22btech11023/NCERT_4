...
\hline
$X$ & $0 \le X \le 10$ & Number of Heads \\
\hline
\end{tabular} 
\end{table}\\
...
X&<7.5\\
\implies Z &< \frac{7.5-\mu}{\sigma} = Z < 1.5811 \\
\pr{X \ge 8}&=1-\pr{Z < 1.5811}
\end{align}
\begin{align}
\pr{Z < 1.5811}&= 0.94308\\
\implies \pr{X \ge 8}&= 0.056923
\end{align}
\item Without correction:
\begin{align}
X &\ge 8\\
Z &\ge \frac{8-\mu}{\sigma} = Z \ge 1.8973\\
\pr{X \ge 8}&=\pr{Z \ge 1.8973}\\
&= 0.02889	
\end{align}
\end{enumerate}
